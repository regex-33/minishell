...
# # CFLAGS = -g -Wall -Wextra -Werror -D BUFFER_SIZE=10
# # CFLAGS += -I ./$(LFT_DIR)/inc -Iinc 
# # LDFLAGS = -L/usr/local/lib -L/usr/lib -L/usr/lib/x86_64-linux-gnu
# # LDLIBS = -L ./ -lft $(shell pkg-config --libs readline ncurses) -O3
...
# 	@echo "\n"
# # @echo "i am here\n"
# 	@$(CC) $^ -o $@ $(CFLAGS) $(LDFLAGS)  $(LDLIBS) -fsanitize=address
# # @echo "i am here\n"
